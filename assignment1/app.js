...
Answer = alert('Welcome to all Banoqabil Students');
...
Answer =  alert("This is the first message of hussain.");
          alert("This is the second message of hussain.");
          alert("This is the third message of hussain.");
...
Answer = var myName = " hussain raza";
let myName = "hussain raza";
const myName = "hussain raza";
...
b) message = "Hello studends ,how  are you";
...
Answer = // Store visitor's information in variables
    var visitorName = "hussain raza"; // Replace with actual visitor's name
